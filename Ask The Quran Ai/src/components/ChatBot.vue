...
const sendMessage = async () => {
  ...
  try {
    ...
    messages.value.push({
      text: "I apologize, but I'm having trouble connecting to the guidance system. Please try again in a moment. If the issue persists, you can try selecting a mood from the dropdown above for immediate Quranic guidance.",
      isUser: false
    });
  } finally {
